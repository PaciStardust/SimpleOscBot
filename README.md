...
An example for a listener that takes data and sends it to multiple other points# SIMPLEOSCBOT
...
* **Listeners**: Information about all the listeners you want to start up at launch of the bot
	...
	* **Data**: An array of data of any type (can be mixed) for the listener to use when starting up (*Ex: Ports to send data to, addresses to listen to*), you have to implement the parsing of those in the listener classes "HandleData" function (An example can be found in the listener examples)
